# -*- coding: UTF-8 -*-
"""
@file:wj_2022_01_26_dataload.py
@author: Wei Jie
@date: 2022/1/26
@description:
"""
...
def AudioLoadData(feature_dataset, train_list, test_list, name_emotion, batchsize, framelen=10, winlen=128):
    ...
    all_list=list(np.arange(5531))
    fea_dataset = dataset.AudioDataset(
        feature=feature_dataset,
        audio_list=all_list,
        name_emotin=name_emotion,
    ...
    fea_loader = torch.utils.data.DataLoader(
        fea_dataset,
        batch_size=1, shuffle=False)

    return train_loader, test_loader,fea_loader
