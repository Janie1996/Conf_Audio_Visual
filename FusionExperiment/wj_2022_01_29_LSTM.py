...
def main(audioN,domainN):
    ...
    checkpoint = torch.load("Checkpoint/Domain_Resnet_" + str(domainN) + "_AV.pth")
    ...
    checkpoint = torch.load("Checkpoint/Audio_DSCASA_"+str(audioN)+".pth")
    ...
    for epoch in range(10):
        ...
        if (epoch > -1):
            ...
            file = open('DATA/log_Fusion.txt', 'a')
