# -*- coding: UTF-8 -*-
"""
@file:wj_2022_01_02_proposed.py
@author: Wei Jie
@date: 2022/1/2
@description:
"""
...
from VideoDataset import wj_2022_01_02_dataload as load_dataset
from VideoModels import wj_2022_01_01_DSCASA_Transformer_LSTM as Model
import pickle

parser = argparse.ArgumentParser()

#parser.add_argument('--audioFeatureRoot', default='DATA/2022_01_01_name_logfbank_dict.pickle', help='root-path for audio')
...
def main():
    ...
    train_loader, test_loader = load_dataset.VideoLoadData(opt.videoRoot, train_list, test_list,
