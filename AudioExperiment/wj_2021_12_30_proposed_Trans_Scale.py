# -*- coding: UTF-8 -*-
"""
@file:wj_2021_12_30_proposed_Trans_Scale.py
@author: Wei Jie
@date: 2021/12/30
@description:
"""
...
from AudioDataset import wj_2021_12_30_dataload_FeaScale as load_dataset
...
def main():
    ...
    for epoch in range(opt.niter):
        ...
        train(train_loader,train_loader1,train_loader2,train_loader3,model,criterion,optimizer,scheduler)
